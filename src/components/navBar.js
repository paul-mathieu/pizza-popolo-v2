...
export default function navBar(nbrR, UserID) {
    return (
        <nav className="navbar navbar-light navbar-expand-lg fixed-top bg-white clean-navbar" id="navbar-element">
            <div className="container">
                ...
                <div className="collapse navbar-collapse" id="navcol-1">
                    <ul className="nav navbar-nav ml-auto">
                        ...
                        <li className="nav-item" role="presentation"><a className="nav-link" href="/catalog">Nos pizzas</a></li>
                        <li className="nav-item" role="presentation"><a className="nav-link" href="/shopping-cart">Votre Panier</a></li>
                        <li className="nav-item" role="presentation"><a className="nav-link" href="/login">Se Connecter</a></li>
                        <li className="nav-item" role="presentation"><a className="nav-link" href="/registration">Créer un compte</a></li>
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" href="/">
                                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="20px" height="20px" viewBox="0 0 475.085 475.085" style={{enableBackground: 'new 0 0 475.085 475.085'}} xmlSpace="preserve">
                                    <g>
                                    <g>
